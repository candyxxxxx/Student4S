...
{	
	...
	public String getRecogActivityTableQuery()
	{
		return "CREATE TABLE IF NOT EXISTS recogactivity ("
				+ "data TEXT NOT NULL, "
				+ "timeStampKey INTEGER NOT NULL "
				+ ");";
	}

	public String getRecogVoiceQuery()
	{
		return "CREATE TABLE IF NOT EXISTS recogvoice ("
				+ "data TEXT NOT NULL, "
				+ "decibel INTEGER, "
				+ "timeStampKey INTEGER NOT NULL "
				+ ");";
